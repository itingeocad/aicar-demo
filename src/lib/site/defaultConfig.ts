...
export const DEFAULT_SITE_CONFIG: SiteConfig = {
  ...
  demoData: {
    ...
    reels: [
      ...
      {
        id: 'r4',
        title: 'Qashqai: РЎвЂЎРЎвЂљР С• РЎРѓР СР С•РЎвЂљРЎР‚Р ВµРЎвЂљРЎРЉ',
        author: 'AICar',
        videoUrl: vid('4'),
        previewUrl: vid('p4'),
        posterUrl: img('reel4'),
      ...
      {
        id: 'r5',
        title: 'Tucson: Р В±РЎвЂ№РЎРѓРЎвЂљРЎР‚РЎвЂ№Р в„– Р С•Р В±Р В·Р С•РЎР‚',
        author: 'AICar',
        videoUrl: vid('5'),
        previewUrl: vid('p5'),
        posterUrl: img('reel5'),
      ...
      {
        id: 'r6',
        title: 'BMW 3: Р Р…Р В° РЎвЂЎРЎвЂљР С• РЎРѓР СР С•РЎвЂљРЎР‚Р ВµРЎвЂљРЎРЉ',
        author: 'AICar',
        videoUrl: vid('6'),
        previewUrl: vid('p6'),
        posterUrl: img('reel6'),
      ...
      {
        id: 'r7',
        title: 'Transit: Р Р†РЎРЊР Р… Р Т‘Р В»РЎРЏ Р В±Р С‘Р В·Р Р…Р ВµРЎРѓР В°',
        author: 'AICar',
        videoUrl: vid('7'),
        previewUrl: vid('p7'),
        posterUrl: img('reel7'),
      ...
      {
        id: 'r8',
        title: 'MTРІР‚вЂ07: Р В·Р Р†РЎС“Р С” Р С‘ Р Т‘Р С‘Р Р…Р В°Р СР С‘Р С”Р В°',
        author: 'AICar',
        videoUrl: vid('8'),
        previewUrl: vid('p8'),
        posterUrl: img('reel8'),
