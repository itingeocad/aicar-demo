...
export const DEFAULT_SITE_CONFIG: SiteConfig = {
  ...
  demoData: {
    ...
    reels: [
      ...
      { id: 'r2', title: 'Passat: С‡С‚Рѕ РїСЂРѕРІРµСЂРёС‚СЊ', author: 'AICar', videoUrl: vid('2'), posterUrl: img('reel2'), linkedCarId: 'c3' },
      { id: 'r3', title: 'CR-V РґР»СЏ СЃРµРјСЊРё', author: 'AICar', videoUrl: vid('3'), posterUrl: img('reel3'), linkedCarId: 'c4' },
      { id: 'r4', title: 'Qashqai: С‡С‚Рѕ СЃРјРѕС‚СЂРµС‚СЊ', author: 'AICar', videoUrl: vid('4'), posterUrl: img('reel4'), linkedCarId: 'c8' }
    ],
    news: [
